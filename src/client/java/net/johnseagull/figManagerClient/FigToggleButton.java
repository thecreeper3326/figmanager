 ...
 * Custom button.
 */
public class FigToggleButton extends Button {
     ...
     * @param onPress Event to be executed on mouseRelease
     ...
     */
    public FigToggleButton(int x, int y, int width, int height, Component label, OnPress onPress, int col1, int col2, int border1, int border2, int borderSize) {
